...
إذا كنت تحتاج إلى عدد أكبر من الفقرات يتيح لك مولد النص العربى زيادة عدد الفقرات كما تريد، النص لن يبدو مقسما ولا يحوي أخطاء لغوية، مولد النص العربى مفيد لمصممي المواقع على وجه الخصوص، حيث يحتاج العميل فى كثير من الأحيان أن يطلع على صورة حقيقية لتصميم الموقع.",
                ...
                "icon" => public_path("test_images/services/service-02.png"),
                "serviceUsages" => [
                    [
                        "title" => [
                            "ar" => "اكتب تفاصيل طلبك",
...
إذا كنت تحتاج إلى عدد أكبر من الفقرات يتيح لك مولد النص العربى زيادة عدد الفقرات كما تريد، النص لن يبدو مقسما ولا يحوي أخطاء لغوية، مولد النص العربى مفيد لمصممي المواقع على وجه الخصوص، حيث يحتاج العميل فى كثير من الأحيان أن يطلع على صورة حقيقية لتصميم الموقع.",
                ...
                "icon" => public_path("test_images/services/service-03.png"),
                "serviceUsages" => [
                    [
                        "title" => [
                            "ar" => "اختر الكابتن المناسب لطلبك",
                            "en"  => "Choose the right captain for your request"
                        ],
                        "description" => [
                            "ar" => "قم بادخال تفاصيل الطلب الخاص بك بدقة للحصول على أفضل خدمة ممكنة",
                            "en"  => "Enter your order details accurately To get the best possible service"
                        ],
                        "icon" => public_path("test_images/services/usage-05.png")
                    ],
                    [
                        "title" => [
                            "ar" => "أختر العناوين للشراء والتسليم",
        ...
        foreach ($services as $service) {
            ...
            $createdService = Service::query()->create([
                "title" => $service['title'],
            ...
            $createdService
                ->addMedia($service["icon"])
                ->preservingOriginal()
                ->toMediaCollection(ServiceEnum::ICON);

            foreach ($service["serviceUsages"] as $serviceUsage) {

                $createdServiceUsage = $createdService->serviceUsages()->create([
                    "title" => $serviceUsage["title"],
                    "description" => $serviceUsage["description"],
                ]);
                $createdServiceUsage
                    ->addMedia($serviceUsage["icon"])
                    ->preservingOriginal()
                    ->toMediaCollection(ServiceEnum::USAGE_ICON);
