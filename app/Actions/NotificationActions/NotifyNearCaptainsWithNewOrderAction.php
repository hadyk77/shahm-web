...
class NotifyNearCaptainsWithNewOrderAction
{
    ...
    public function handle(Order $order, $excludeCaptainId = null): void
    {
        ...
        $captains = User::query()
            ...
            ->get();
        dd($captains, Helper::getLocationDetailsFromGoogleMapApi($captain->address_lat, $captain->address_long, $order->pickup_location_lat, $order->pickup_location_long)["distanceValue"]);
