...
<div class="d-flex flex-column flex-root" id="kt_app_root">
    <div class="d-flex flex-column flex-lg-row flex-column-fluid">
        ...
        <div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2" style="background-image: url('{{asset("admin/media/auth/bg7.jpg")}}')">
            <div class="d-flex flex-column flex-center py-15 px-5 px-md-15 w-100">
                <img class="mx-auto w-275px w-md-50 w-xl-800px mb-10 mb-lg-20" src="{{asset("admin/media/misc/auth-screens.png")}}" alt="" />
