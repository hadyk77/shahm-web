...
<div class="app-navbar flex-shrink-0">
    <div class="app-navbar-item ms-1 ms-lg-3">
        <div class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-35px h-35px w-md-40px h-md-40px position-relative" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
            ...
            <span id="notification_dots" class="@if(Auth::user()->unreadNotifications()->count() > 0) bullet bullet-dot bg-danger h-6px w-6px position-absolute translate-middle top-0 start-50 animation-blink @endif"></span>
        </div>
        <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px"
            ...
            <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('{{asset("admin/media/misc/pattern-1.jpg")}}')">
                <h3 class="text-white fw-semibold px-9 mt-10 mb-6">{{__("Notifications")}}
                    <span class="fs-8 opacity-75 ps-3"> <span id="notification_count">{{Auth::user()->unreadNotifications()->count()}}</span> {{__("Un read notification")}}</span>
                </h3>
            </div>
    ...
    <div class="app-navbar-item ms-1 ms-lg-3">
        ...
        <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px"
            ...
            <div class="d-flex flex-column flex-center bgi-no-repeat rounded-top px-9 py-10" style="background-image:url('{{asset('admin/media/misc/pattern-1.jpg')}}')">
                <h3 class="text-white fw-semibold mb-0">{{__("Quick Links")}}</h3>
            </div>
            <div class="row g-0">
                @can("users")
                    <div class="col-6">
                        ...
                        <span class="svg-icon svg-icon-3x svg-icon-primary mb-2">
                            ...
                            <span class="fs-5 fw-semibold text-gray-800 mb-0">{{__("Clients")}}</span>
                        </a>
                    </div>
                    <div class="col-6">
                        <a href="{{route('admin.captain.index')}}" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-bottom">
                        <span class="svg-icon svg-icon-3x svg-icon-primary mb-2">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span class="fs-5 fw-semibold text-gray-800 mb-0">{{__("Captains")}}</span>
                        </a>
                    </div>
                    <div class="col-6">
                        ...
                        <span class="svg-icon svg-icon-3x svg-icon-primary mb-2">
                            ...
                            <span class="fs-5 fw-semibold text-gray-800 mb-0">{{__("Verifications")}}</span>
                        </a>
                    </div>
                @endcan
                @can("contact_us")
                        <div class="col-6">
                            <a href="{{route('admin.contact.index')}}" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light">
                        <span class="svg-icon svg-icon-3x svg-icon-primary mb-2">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span class="fs-5 fw-semibold text-gray-800 mb-0">{{__("Contacts")}}</span>
                            </a>
                        </div>
                @endcan
            </div>
    ...
    <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
        <div class="cursor-pointer symbol symbol-35px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
            <img src="{{Auth::guard(\App\Enums\GuardEnum::ADMIN)->user()->profile_image}}" alt="user"/>
        </div>
        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
            ...
            <div class="menu-item px-5 my-1">
                <a href="{{route("admin.profile.index")}}" class="menu-link px-5">{{__("Account Settings")}}</a>
            </div>
            @include('global-partials.languages')
            <div class="menu-item px-5">
                <a href="javascript:;" class="menu-link px-5 logoutBtn"
                   data-url="{{route('admin.logout')}}">{{__("Sign Out")}}</a>
            </div>
        </div>
    </div>
